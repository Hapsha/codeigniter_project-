...
class model_vehicle extends CI_Model {
	...
	public function insert($featured,$image,$manufacturer_id,$model_id,$category,$buying_price,$add_date,$status,$registration_year,$insurance_id,$doors,$user_id,$color)
	{
		$data = array(
			'featured' => $featured,
			'image' => $image,
