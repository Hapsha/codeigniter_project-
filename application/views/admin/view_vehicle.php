...
<div class="right_col" role="main">
    <div class="">
        ...
        <hr>
        <a class="btn btn-primary" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> Add A new Furniture</a>
        ...
        <div class="row">
			...
			<?php echo form_open_multipart('admin/vehicles/add'); ?>
                <fieldset>
                    <div class="row">
                        <div class="col-xs-6">
                            <label>Furniture Manufacturer</label>                            
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <br>
                            <input type="number" class="form-control" name="doors" placeholder="Size" required>
                        </div>
                    </div>
...
<br>
                    ...
                    <br>
                    <input class="btn btn-primary" type="submit" name="buttonSubmit" value="Add New Furniture" />
