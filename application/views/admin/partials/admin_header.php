        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
             <a href="<?= base_url('admin/dashboard'); ?>" class="site_title"><i class="fa fa-paw"></i> <span>ATP-III DARAZ</span></a>
            </div>
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Manage Employee <span class="fa fa-chevron-down"></span></a>
                    ...
                    <?php endif; ?>
                  <li><a><i class="fa fa-table"></i> Furnitures <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('admin/vehicles'); ?>">All Furnitures</a></li>
                      <li><a href="<?= base_url('admin/vehicles/soldlist'); ?>">Sold Furnitures</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
