				...
				<div class="col-md-3">
					<div class="menu_box">
				   	     ...
				   	     <ul class="nav">
					   	  	...
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Living Room</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Office Furniture</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Bean Bags</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Tables</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Sofas</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Wardrobes</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Beds</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Chairs</a></li>
					   	  	<li><a href="<?php echo base_url() ; ?>web/about">Kids Beds</a></li>
					   	 </ul>
			   	    </div>
			   	 </div>
			  <div class="col-md-9">
			    <div class="dreamcrub">
                    ...
                    <li class="home">
                       <a href="<?php echo base_url() ; ?>web/index" title="Go to Home Page">Home</a>&nbsp;
                       <span>&gt;</span>
                    </li>
                    <li class="home">&nbsp;
                        &nbsp;Account
                ...
                <ul class="previous">
                	<li><a href="<?php echo base_url() ; ?>web/index">Back to Previous Page</a></li>
                </ul>
