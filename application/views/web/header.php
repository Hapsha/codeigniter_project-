...
<script src="<?php echo base_url() ; ?>resource/js/simpleCart.min.js"> </script>
<script src="<?php echo base_url() ; ?>resource/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<link href="<?php echo base_url() ; ?>resource/css/style.css" rel='stylesheet' type='text/css' />
<link href="<?php echo base_url() ; ?>resource/css/component.css" rel='stylesheet' type='text/css' />
<!-- Custom Theme files -->
<!--webfont-->
<link href='//fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
<!--//webfont-->
<script src="<?php echo base_url() ; ?>resource/js/jquery.easydropdown.js"></script>
<!-- Add fancyBox main JS and CSS files -->
<script src="<?php echo base_url() ; ?>resource/js/jquery.magnific-popup.js" type="text/javascript"></script>
<link href="<?php echo base_url() ; ?>resource/css/magnific-popup.css" rel="stylesheet" type="text/css">
		<script>
...
<div class="header">	
      <div class="container"> 
         <div class="header-top">
      		 <div class="logo">
				<a href="<?php echo base_url('pages/index') ; ?>"><h6>Online Furnish</h6><h2>Luxury</h2></a>
			 </div>
		 ...
		 <div class="banner_wrap">
			<div class="bannertop_box">
   		 		<ul class="login">
   		 			<li class="login_text"><a href="<?php echo base_url() ; ?>login">Login</a></li>
   		 			<li class="wish"><a href="<?php echo base_url() ; ?>web/checkout">Wish List</a></li>
   		 			<div class='clearfix'></div>
   		 		</ul>
   		 		<div class="cart_bg">
	   		 	  <ul class="cart">
	   		 		 <a href="<?php echo base_url() ; ?>web/checkout">
			  	...
			  	<ul class="quick_access">
   		 			<li class="view_cart"><a href="<?php echo base_url() ; ?>web/checkout">View Cart</a></li>
   		 			<li class="check"><a href="<?php echo base_url('pages/check') ; ?>">Checkout</a></li>
   		 			<div class='clearfix'></div>
   		 		</ul>
   		 		<div class="search">
