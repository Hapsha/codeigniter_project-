...
class Vehicles extends CI_Controller {
	...
	{	
		if($this->input->post('buttonSubmit')) {
            ...
            $this->model_vehicle->insert($featured,$image,$manufacturer_name,$model_name,$category,$b_price,$add_date,$status,$registration_year,$insurance_id,$doors,$e_no,$c_no,$u_id,$v_color);
